...
namespace Unity.FPS.Gameplay
{
    ...
    public class PlayerCharacterController : MonoBehaviour
    {
        ...
        //public AudioClip FootstepSfx;     '//' comments out the code
        ...
        void OnDie()
        {
            ...
            FPSEventManager.Broadcast(Events.PlayerDeathEvent);
        }
            ...
            bool isSprinting = m_InputHandler.GetSprintInputHeld();
            {
                ...
                if (IsGrounded)
                {
                    ...
                    if (m_FootstepDistanceCounter >= 1f / chosenFootstepSfxFrequency)
                    {
                        ...
                        //3D
                        //RuntimeManager.PlayOneShotAttached(FootstepSfx, gameObject);  //Tracks the object position every frame
                        // OR
                        //RuntimeManager.PlayOneShot(FootstepSfx, transform.position);  //Fire the event at the object position, but doesn't update after creation. 
                    }
